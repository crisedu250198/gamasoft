...
const FooterContainer = () =>{
    ...
    <>
        <div class="containerBackground">
            <div class="containerFormSuscripcion container">
                <form action="https://formspree.io/f/xknkkdzp"
                method="POST">
                    <label for="">Recibí las mejores ofertas en tu e-mail</label>
                    <input type="text" name="Nombre" id="entrada_Nombre" placeholder="  Ingresa tu nombre" class="inputText"/>
                    <input type="email" name="_replyto" id="entrada_Email" placeholder="   Ingresa tu email" class="inputText"/>
                    <button>Suscribite</button>
                </form>
            </div>
        </div>
        <div className="footer__containerAyuda--Fondo">
            <section class="footer__containerAyuda row">
                <article class="col-4">
                    <h3>Información</h3>
                    ...
                    <div class="footer__containerAyuda--Menu">
                        <h4>Menu</h4>
                        <nav>
                            <ul>
                                <li>
                ...
                <article class="col-4">
                    ...
                    <nav class="footer__Redes">
                        <ul>
                            <li>
                                <a href="https://www.facebook.com/" target="_blank" ><img src= {require("../images/facebook.png")} alt="Icono de Facebook"/></a>
                            </li>
                            <li>
                                <a href="https://www.instagram.com/"target="_blank"><img src={require("../images/instagramColor.png")} alt="Icono de instagram"/></a>
                            </li>
                            <li>
                                <a href="https://web.whatsapp.com/" target="_blank"><img src={require("../images/whatsappColor.png")} alt="Icono de Whatsapp"/></a>
                            </li>
                        </ul>
                    </nav>
                </article>
